...
def evaluate_ppl(model, dev_data, batch_size=32):
    ...
    #### perplexity越小越好
    #### Hope the likelihood of P(w1,w2,w3,....wn) bigger and also normalized by the number of word
...
def train(args: Dict):
    ...
    """
    train_data_src = read_corpus(args['--train-src'], source='src', vocab_size=21000)    #### tokenize each line   
    ...
    valid_niter = int(args['--valid-niter'])  #iteration 多少次後回報validation的結果
    log_every = int(args['--log-every'])      #iteration 多少次後回報training的結果
